...
func TestCopyFileWithInvalidSrc(t *testing.T) {
	tempFolder, err := os.MkdirTemp("", "bhojpur-fileutils-test") // #nosec G303
...
func TestCopyFileWithInvalidDest(t *testing.T) {
	tempFolder, err := os.MkdirTemp("", "bhojpur-fileutils-test")
	defer os.RemoveAll(tempFolder)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMatches(t *testing.T) {
	...
	multiPatternTests := []multiPatternTestCase{
		{[]string{"**", "!util/bhojpur/web"}, "util/bhojpur/web/foo", false},
		{[]string{"**", "!util/bhojpur/web", "util/bhojpur/web/foo"}, "util/bhojpur/web/foo", true},
	}
