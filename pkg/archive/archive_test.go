...
func TestUntarPathWithInvalidDest(t *testing.T) {
	tempFolder, err := os.MkdirTemp("", "bhojpur-archive-test")
...
func TestUntarPathWithInvalidSrc(t *testing.T) {
	dest, err := os.MkdirTemp("", "bhojpur-archive-test")
	if err != nil {
		t.Fatalf("Fail to create the destination file")
	}
...
func TestUntarPath(t *testing.T) {
	...
	tmpFolder, err := os.MkdirTemp("", "bhojpur-archive-test")
	assert.NilError(t, err)
...
func TestCopyFileWithTarSrcFolder(t *testing.T) {
	folder, err := os.MkdirTemp("", "bhojpur-archive-copyfilewithtar-test")
	if err != nil {
		t.Fatal(err)
	}
	defer os.RemoveAll(folder)
...
func checkNoChanges(fileNum int, hardlinks bool) error {
	srcDir, err := os.MkdirTemp("", "bhojpur-test-srcDir")
	if err != nil {
		return err
	}
	defer os.RemoveAll(srcDir)

	destDir, err := os.MkdirTemp("", "bhojpur-test-destDir")
	if err != nil {
		return err
	}
...
func tarUntar(t *testing.T, origin string, options *TarOptions) ([]Change, error) {
	...
	tmp, err := os.MkdirTemp("", "bhojpur-test-untar")
	if err != nil {
		return nil, err
	}
...
func TestDetectCompressionZstd(t *testing.T) {
	...
	compressedData := []byte{
		...
		0x64, 0x6f, 0x63, 0x6b, 0x65, 0x72, // data block "bhojpur"
...
func TestTarUntar(t *testing.T) {
	origin, err := os.MkdirTemp("", "bhojpur-test-untar-origin")
	if err != nil {
		t.Fatal(err)
	}
...
func TestTarWithOptionsChownOptsAlwaysOverridesIdPair(t *testing.T) {
	origin, err := os.MkdirTemp("", "bhojpur-test-tar-chown-opt")
	assert.NilError(t, err)
...
func TestTypeXGlobalHeaderDoesNotFail(t *testing.T) {
	...
	tmpDir, err := os.MkdirTemp("", "bhojpur-test-archive-pax-test")
	if err != nil {
		t.Fatal(err)
	}
...
func BenchmarkTarUntar(b *testing.B) {
	...
	tempDir, err := os.MkdirTemp("", "bhojpur-test-untar-destination")
	if err != nil {
		b.Fatal(err)
	}
...
func TestUntarInvalidFilenames(t *testing.T) {
	for i, headers := range [][]*tar.Header{
		...
		if err := testBreakout("untar", "bhojpur-TestUntarInvalidFilenames", headers); err != nil {
...
func TestUntarHardlinkToSymlink(t *testing.T) {
	...
	for i, headers := range [][]*tar.Header{
		...
		if err := testBreakout("untar", "bhojpur-TestUntarHardlinkToSymlink", headers); err != nil {
			t.Fatalf("i=%d. %v", i, err)
		}
	}
}
...
func TestUntarInvalidHardlink(t *testing.T) {
	for i, headers := range [][]*tar.Header{
		...
		if err := testBreakout("untar", "bhojpur-TestUntarInvalidHardlink", headers); err != nil {
			t.Fatalf("i=%d. %v", i, err)
		}
	}
}
...
func TestUntarInvalidSymlink(t *testing.T) {
	for i, headers := range [][]*tar.Header{
		...
		if err := testBreakout("untar", "bhojpur-TestUntarInvalidSymlink", headers); err != nil {
			t.Fatalf("i=%d. %v", i, err)
		}
	}
}
...
func TestDisablePigz(t *testing.T) {
	...
	os.Setenv("BHOJPUR_DISABLE_PIGZ", "true")
	defer os.Unsetenv("BHOJPUR_DISABLE_PIGZ")
